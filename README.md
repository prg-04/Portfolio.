...
- [Live Demo Link](https://prg-04.github.io/Portfolio_/)
...
- Login to your github account and search for 'prg-04/Portfolio\_'
...
- After cloning the repository change the directory using 'cd Portfolio\_' to access the files.
...
- In your terminal window type: git clone https://github.com/prg-04/Portfolio_.git
...
Feel free to check the [issues page](https://github.com/prg-04/Portfolio_/issues).
